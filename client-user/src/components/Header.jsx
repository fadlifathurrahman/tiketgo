...
function Header() {
  const { bookedSeats, setBookedSeats, bookedSeatsId, setBookedSeatsId, price, hasLogin, setHasLogin } = useContext(UserContext);
          ...
          <nav className="flex flex-wrap gap-5">
            <ul className="flex flex-wrap justify-end items-center m-0 p-0">
              <li className="px-6 py-[5px] relative list-none">
                <Link to="/" className="uppercase text-[#e9eeff] text-base font-bold p-[5px] relative">
                  Home
                </Link>
              </li>
            </ul>
